import { ArrowDown, Store as StoreIcon } from "lucide-react";
// import chaiVideo from "@/assets/chai-tapri.mp4";
                ...
                <div className="relative z-10 flex h-full items-center justify-center px-6">
                    <div className="max-w-4xl text-center text-white">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                            ...
                            <button className="rounded-full border border-white/40 px-6 py-3 hover:bg-white hover:text-black transition flex items-center gap-2 justify-center">
                                <StoreIcon size={18} /> Our Story
                            </button>
                        </div>
